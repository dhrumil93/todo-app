    ...
    <div className="flex items-center justify-center flex-col">
      ...
      >
        ...
        <div className="mb-4 flex items-center border shadow-sm p-4 bg-amber-100 text-amber-700 rounded-full uppercase">
          ...
          <span className="pt-1">Collaborate, Organize, Achieve</span>
        ...
        <div
          className={cn(
            "text-2xl md:text-6xl text-white p-3 md:p-4 rounded-md w-fit",
            gradient[2]
          )}
        >
          One List, Many Contributors, Endless Possibilities.
        </div>
      </div>
      {/* Promotional Text */}
      <div
